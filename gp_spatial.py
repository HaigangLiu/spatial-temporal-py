...
if __name__ == '__main__':
    data_form = pd.read_csv('./data/with_sst_5_years.csv')
    from SampleDataLoader import load_sample_data_spatial
    data = load_sample_data_spatial()
    test_case = GPModelSpatial(2015, 10, data, 'PRCP')
