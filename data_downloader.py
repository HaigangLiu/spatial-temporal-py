...
class DailyFloodDataDownloader:
    ...
    def parsing_engine(self):
        '''
        Multiprocessing will be tried first. If it faisl,
...
if __name__ == '__main__':
    ...
    scraped_webpages = DailyFloodDataDownloader().parsing_engine()
    print(scraped_webpages.head())
    #scraped_webpagesest.to_csv('./data/flood_data_daily.csv')
